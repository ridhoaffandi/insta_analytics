...
select distinct
	...
	mi."CAROUSEL_ALBUM_VIEWS",
	mi."CAROUSEL_ALBUM_SAVED" ,
	mi."CAROUSEL_ALBUM_SHARES",
...
from media_insights
where
"CAROUSEL_ALBUM_VIEWS" is not null ) as mi
on mv."ID" = mi."ID"
...
INTERMEDIATE_TABLE = "insta_album"
...
def upload_csv_to_postgres(csv_path, table_name, db_config):
    ...
    cursor.execute("TRUNCATE TABLE insta_album")
